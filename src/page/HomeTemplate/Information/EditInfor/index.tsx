          ...
          <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16 bg-white rounded-[8px]">
            ...
            <form action="#" onSubmitCapture={formik.handleSubmit}>
              <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                <div className="w-full">
                  ...
                  <input
                    type="text"
                    name="taiKhoan"
                    className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg   block w-full p-2.5  cursor-no-drop"
                ...
                <div className="w-full relative">
                  ...
                  <input
                    ...
                    name="matKhau"
                    className={`bg-gray-50 border-[1px] border-gray-300 text-gray-900 text-sm rounded-lg   block w-full p-2.5 ${
                      formik.errors.matKhau &&
                      formik.touched.matKhau &&
                      "  !border-[rgba(240,23,23,.835)]"
                    }`}
                    value={formik.values.matKhau}
                    onChange={formik.handleChange}
                  />
                  {formik.errors.matKhau && formik.touched.matKhau && (
                    <div className=" w-full text-[rgba(240,23,23,.835)]">
                  ...
                  {!status && (
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-6 h-6 absolute right-[6px] top-9 transition-opacity delay-150"
                      onClick={() => {
                        setStatus(true);
                      }}
                    >
              ...
              <div className="flex items-center space-x-4">
                <button
                  type="button"
                  className="text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-[20px] py-[10px] text-center "
                  onClick={() => {
                ...
                <button
                  disabled={data.data || data.error}
                  type="submit"
                  className="text-green-600 inline-flex items-center hover:text-white border border-green-600 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-[20px] py-[10px] text-center "
                >
                  Cập nhật
                </button>
              </div>
